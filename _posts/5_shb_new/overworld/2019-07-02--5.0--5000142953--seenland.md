...
fates:
  - id: "1506"
    title:
      de: "Krakeelende Gremlins"
      en: "Don't Feed the Gremlins"
      fr: "Pas venu ici pour souffrir"
      ja: "あれってまさか、グレムリン？"
      cn: "格雷姆林不能惯着"
      ko: "저건 설마 그렘린?"
    desc: "There is some debate as to whether gremlins truly believe the vitriol they spew, or simply get satisfaction from riling their victims. In either case, it's common knowledge that the best option is not to engage─but pummeling them is by far the more satisfying one."
  - id: "1510"
    title:
      de: "Knackiges Chamäleon"
      en: "Calm a Chameleon"
      fr: "Défi : le Casse-noisette excédé"
      ja: "激憤の大物「ヌスクナッカー」"
      cn: "愤怒巨物——努斯克纳卡"
      ko: "격분한 거물"
    desc: "Though the fisher's catch has been preserved in an at least semi-edible state, it unfortunately transpires that violence against anemones causes them to release foul pheromones in even greater quantities. Nussknacker does not appear best pleased by this befouling of its territory."
  - id: "1500"
    title:
      de: "Er ist Holzfäller und ihm geht's nicht gut"
      en: "Pick-up Sticks"
      fr: "Dur dur d'être un bûcheron"
      ja: "木こり歌の事"
      cn: "樵夫之歌"
      ko: "나무꾼의 노래"
    desc: "The efforts of a logger come to harvest timber for vital construction in the Crystarium have been stymied by territorial triffids. For an experienced hero, however, retrieving the fallen lumber should be as child's play."
  - id: "1509"
    title:
      de: "Anemositäten"
      en: "Behind Anemone Lines"
      fr: "Il est frais, mon poisson"
      ja: "ハイエボリューション"
      cn: "高度进化"
      ko: "바람꽃"
    desc: "Though little in this world smells worse than sun-ripened fish, sun-ripened fish that's spent any amount of time near malodorous anemones certainly qualifies. Those who would prefer not to have their noses opened to a whole new world of stench had best assist the local fisher in rescuing his catch before it's too late."
---
