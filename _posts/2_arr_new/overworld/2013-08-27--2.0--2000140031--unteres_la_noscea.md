...
fates:
  - title:
      de: "Krötenplage"
      en: "You Call That a Toad"
      fr: "Problème de nuisibles"
      ja: "蛙の子は蛙"
      cn: "蛙蛙子"
      ko: "새끼 치는 두꺼비"
    id: "249"
    icon: "060000/060721_hr1.png"
    desc: "When the wheat farmers of lower La Noscea were losing large portions of their crops to locusts, they turned to Mealvaan's Gate who introduced Cieldalaes cane toads to the fields to devour the vilekin. Unfortunately, the cane toads, who have no natural predators on Vylbrand, have taken over the region, leaving the farms with no choice but to slay them all."
    type: "Gegner Besiegen"
    fatelevel: "4"
    fatelevel_sync: "9"
  - title:
      de: "Der Albtraumprinz"
      en: "One Prince"
      fr: "Défi : le prince"
      ja: "不吉なる王子「マンドラプリンス」"
      cn: "王家惨剧——蔓德拉王子"
    ...
    desc: "While little is known about mandragoras, what is known tends to be quite disturbing. Such is the case with the mandragora prince, who is rumored to journey to the sites of slaughters so it might feed off the blood-soaked loam. It is probably best to not let it feed off the blood-soaked loam."
    type: "Boss besiegen"
    fatelevel: "13"
    fatelevel_sync: "18"
---
