...
contentdescription:
    ...
    ko: "이딜샤이어에 나타난, 말하는 기묘한 여우 총당님. 자신을 다도의 종담이라고 밝힌 그는 다과회의 이야깃거리를 찾으러 왔다고 한다.<br/>그를 위해 귀신 주르반과 벌인 사투를 떠올린다. 선악의 틈새에서 맞부딪치는 칼날. 영겁의 승리를 거머쥘 자는 귀신인가, 모험가인가. 지금 환상의 격투가 펼쳐진다."
mechanics:
  - title:
      de: "Mechanic-Title 1"
      en: "Mechanic-Title 1"
