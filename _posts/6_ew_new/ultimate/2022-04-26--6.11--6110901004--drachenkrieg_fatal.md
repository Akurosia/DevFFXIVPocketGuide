    ...
    attacks:
      ...
      - title:
        ...
        phases:
          - phase: "09"
      - title:
          de: "Verwobener Feuertod"
          en: "Entangled Pyre"
          fr: "Bûcher Enchevêtré"
          ja: "道連れの爆炎"
          cn: "同归于尽之爆炎"
          ko: "길동무 불길"
        title_id: "742D"
  ...
  - title:
    ...
    debuffs:
      ...
      - title:
        ...
        description:
          de: "Erleidet schrittweise Dunkelschaden."
          en: "Darkness is causing damage over time."
          fr: "Des dégâts périodiques de Ténèbres sont subis."
          ja: "闇属性ダメージにより、ＨＰが徐々に失われる状態。"
          cn: "受到暗属性的持续伤害，体力逐渐流失"
          ko: "어둠속성 피해로 HP가 서서히 줄어드는 상태."
        durations: [120]
        debuff_in_use: "false"
        disable: "false"
        phases:
  ...
  - title:
    ...
    debuffs:
      ...
      - title:
        ...
        description:
          de: "Erleidet schrittweise Lichtschaden."
          en: "Light is causing damage over time."
          fr: "Des dégâts périodiques de Lumière sont subis."
          ja: "光属性ダメージにより、ＨＰが徐々に失われる状態。"
          cn: "受到光属性的持续伤害，体力逐渐流失"
          ko: "빛속성 피해로 HP가 서서히 줄어드는 상태."
        durations: [120]
        debuff_in_use: "false"
        disable: "false"
        phases:
