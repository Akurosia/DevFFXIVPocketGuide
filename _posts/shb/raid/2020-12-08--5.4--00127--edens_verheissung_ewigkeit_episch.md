  ...
  - title: "Orakel Der Dunkelheit"
    ...
    debuffs:
      ...
      - title: "Verzögerung: Quietus"
        ...
        icon: "ui/icon/015000/015341.png"
    ...
    sequence:
      ...
      - phase: "03"
        ...
        toolbox:
          - link: "https://ff14.toolboxgaming.space/?id=374927149043161&preview=1"
            name: "Single Apokalypse"
        mechanics:
          - title: "Safespots nach Kataklysmus"
            notes:
              - note: "Ranges können dort stehen bleiben, wo sie dem Kataklysmus ausgewichen sind."
              - note: "Nach der ersten Apokalypse können die Ranges in die Mitte gehen"
              - note: "Melees sollten sich entgegengesetzet zum Licht hinstellen (Wenn das Licht im Boden im Uhrzeigersinn geht stellt die Spieler in der entgegengesetzen Richtung hin)"
              - note: "Nach der ersten Apokalypse können die Melees in die Mitte gehen, müssen aber auf der Linie entlang laufen, da sie sonst von der 2. Apokalypse getroffen werden"
              - note: "Alternativ können die Melees auch einfach nach der 2. Apokalypse in die Mitte gehen um sicher zu sein (dann aber direkt laufen für den Stack)"
        attacks:
      ...
      - phase: "04"
        ...
        toolbox:
          - link: "https://ff14.toolboxgaming.space/?id=297921982193161&preview=1"
            name: "Angepasste Intermediäre Relativität"
        mechanics:
          - title: "Debuffs in: Grundlegende Relativität"
            notes:
      ...
      - phase: "05"
        ...
        toolbox:
          - link: "https://ff14.toolboxgaming.space/?id=447523768739061&preview=1"
            name: "Doppelte Apokalypse"
        mechanics:
          - title: "Safespots nach Kataklysmus"
            notes:
              - note: "Ranges sollten nach Kataklysmus 90° versetzt zu den Lichter rausgehen und die erste Apokalypse abwarten und nach dieser in die Mitte gehen."
              - note: "Melees(DDs) sollten sich entgegengesetzet zum Licht hinstellen (Wenn das Licht im Boden im Uhrzeigersinn geht stellt die Spieler in der entgegengesetzen Richtung hin) und danach ebenfalls in die Mitte gehen."
              - note: "Melees (DDs) und Ranges sollten an der Hotbox des Bosses stehen, allerdings nicht in der Hitbox."
              - note: "MT stellt sich leicht auserhalb des Bosses entgegengesetzet zum Licht und geht nach dem 1. Sprung zur Gruppe"
              - note: "OT stellt sich so hin, das er nach dem ersten Sprung des Bosses, noch immer in der Hitbox steht, in Laufrichtung des Licht und geht nach dem 2. Sprung zur Gruppe"
        attacks:
      ...
      - phase: "06"
        ...
        toolbox:
          - link: "https://ff14.toolboxgaming.space/?id=397920453193161&preview=1"
            name: "Abgepasste Fortgeschrittene Relativität"
        mechanics:
        ...
        attacks:
          ...
          - attack: "Geschwindigkeit (Schnell + Langsam (Sanduhren-Verbindungen))"
          - attack: "12sek für 1. 'Verzögerung: Giga-Rückführung' (Position für den 31Sek Debuff) + Verzögerung: Dunkel-Aquaga (die mit den Schattenaugen)"
          - attack: " 4sek für 2. 'Verzögerung: Rückgabe' (Position für den 31Sek Debuff)"
          - attack: " 7sek für 3. 'Rückführung' (Position für den 31Sek Debuff) + alle Dunkel-Feuga + ein Teil des Doppel Dunkel-Windga"
          - attack: "alle Verzögerung: Schattenauge"
          - attack: "zweiter Teil des Doppel Dunkel-Windga"
          - attack: "Verzögerung: Dunkel-Aquaga (die mit Doppel Dunkel-Windga)"
          - attack: "Schockwellenpulsar"
      - phase: "07"
        name: "Dreifache Apokalypse"
        toolbox:
          - link: "https://ff14.toolboxgaming.space/?id=210228541987061&preview=1"
            name: "Tripple Apocalypse"
        attacks:
