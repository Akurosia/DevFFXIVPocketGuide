      ...
      - title:
        ...
        variation:
          ...
          - title_id: "7753"
            damage_type: "None"
            add_status:
              - status: {'status': 'B5F', 'icon': '015000/015520.png', 'name': {'de': 'Schaden -', 'en': 'Damage Down', 'fr': 'Malus de dégâts', 'ja': 'ダメージ低下', 'cn': '伤害降低', 'ko': '주는 피해량 감소'}}
                icon: "015000/015520.png"
                name:
                 de: "Schaden -"
                 en: "Damage Down"
      ...
      - title:
        ...
        variation:
          ...
          - title_id: "7762"
            damage_type: "Magical"
            add_status:
              - status: {'status': '24B', 'icon': '015000/015623.png', 'name': {'de': 'Gabelblitz', 'en': 'Forked Lightning', 'fr': 'Éclair ramifié', 'ja': 'フォークライトニング', 'cn': '叉形闪电', 'ko': '갈래 번개'}}
                icon: "015000/015623.png"
                name:
                 de: "Gabelblitz"
                 en: "Forked Lightning"
      ...
      - title:
        ...
        variation:
          - title_id: "7750"
            damage_type: "Magical"
            add_status:
              - status: {'status': 828, 'icon': '015000/015530.png', 'name': {'de': 'Blutung', 'en': 'Bleeding', 'fr': 'Saignement', 'ja': 'ペイン', 'cn': '出血', 'ko': '고통'}}
      ...
      - title:
        ...
        variation:
          - title_id: "7678"
            damage_type: "None"
            add_status:
              - status: {'status': '82B', 'icon': '015000/015057.png', 'name': {'de': 'Erhöhte Magie-Verwundbarkeit', 'en': 'Magic Vulnerability Up', 'fr': 'Vulnérabilité magique augmentée', 'ja': '被魔法ダメージ増加', 'cn': '魔法受伤加重', 'ko': '받는 마법 피해량 증가'}}
                icon: "015000/015057.png"
                name:
                 de: "Erhöhte Magie-Verwundbarkeit"
                 en: "Magic Vulnerability Up"
      ...
      - title:
        ...
        variation:
          ...
          - title_id: "74B1"
            damage_type: "None"
            add_status:
              - status: {'status': 'B7D', 'icon': '015000/015057.png', 'name': {'de': 'Erhöhte Magie-Verwundbarkeit', 'en': 'Magic Vulnerability Up', 'fr': 'Vulnérabilité magique augmentée', 'ja': '被魔法ダメージ増加', 'cn': '魔法受伤加重', 'ko': '받는 마법 피해량 증가'}}
                icon: "015000/015057.png"
                name:
                 de: "Erhöhte Magie-Verwundbarkeit"
                 en: "Magic Vulnerability Up"
