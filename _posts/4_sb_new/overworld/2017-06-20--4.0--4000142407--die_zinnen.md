...
fates:
  - title:
      de: "Mit dem Kopf durch den Wald"
      en: "You Don't Know Jack"
      fr: "Défi : le bûcheron silencieux"
      ja: "沈黙の木樵「ランバージャック」"
      cn: "沉默的木樵——樵夫杰科"
      ko: "말 없는 나무꾼"
    id: "1181"
    icon: "060000/060722_hr1.png"
    desc: "While some beetles will scour forests for entire days in search of wounded trees from which they can sip sticky sweet sap, one particular vilekin simply uses its head. Literally. Lumber Jack is notorious for violently butting against solemn sentinels until they topple so he may suck the life from the exposed trunk. If let to continue, there might not be a single tree left in all the Peaks come winter."
    type: "Boss besiegen"
    fatelevel: "61"
    fatelevel_sync: "65"
  - title:
      de: "Zum Fressen gern"
      en: "Love Me, Tindalos"
      fr: "Défi : l'immonde chien féroce"
      ja: "不浄なる獣「ティンダロス」"
      cn: "污秽之兽——廷达洛斯"
      ko: "부정한 짐승"
    id: "1191"
    icon: "060000/060722_hr1.png"
    desc: "They say that dogs are a man's best friend. Tindalos, on the other hand, is no friend to man...or woman, for that matter. Tindalos is merely hungry, and would rather devour any and all who dare cross his path than make their humble acquaintance."
    type: "Boss besiegen"
    fatelevel: "68"
    fatelevel_sync: "72"
  - title:
      de: "Ein flotter Schnitt"
      en: "Barbershoppe"
      fr: "Défi : le Barbier diabolique"
      ja: "伝説の藪医者「ブルータルバーバー」"
      cn: "传说中的剪刀尾——粗暴理发师"
      ko: "전설적인 돌팔이 의사"
    id: "1185"
    icon: "060000/060722_hr1.png"
    desc: "Despite his title, the Brutal Barber is by no means a licensed practitioner of medicine, and any limbs entrusted to his care will most likely be lopped off, regardless of whether or not they require medical treatment."
    type: "Boss besiegen"
    fatelevel: "61"
    fatelevel_sync: "65"
  - title:
      de: "Alter Falter"
      en: "Days of Fluturini Past"
      fr: "Éclosion lépidoptère"
      ja: "胡蝶の夢"
      cn: "蝴蝶梦"
      ko: "나비의 꿈"
    id: "1187"
    icon: "060000/060721_hr1.png"
    desc: "Adult fluturini will lay hundreds of eggs each day, and while some of these eggs will be consumed by predators, their sheer number ensures that many will survive to hatch...grow...and kill. Seek out and swat the swarms which threaten to wreak havoc in the Peaks."
    type: "Gegner Besiegen"
    fatelevel: "60"
    fatelevel_sync: "64"
  - title:
      de: "Zum Greifen nah"
      en: "The Day of the Griffins"
      fr: "Oiseau de proie"
      ja: "血より生まれし"
      cn: "自血而生"
      ko: "피로부터 생을 얻노라"
    id: "1196"
    icon: "060000/060721_hr1.png"
    desc: "The founders of Ala Mhigo chose the griffin for their kingdom's standard for its strength, ferocity, cunning, and endurance─all traits that make the winged beastkin one of the most deadly creatures you will ever meet, if not the last creature you ever meet."
    type: "Gegner Besiegen"
    fatelevel: "68"
    fatelevel_sync: "72"
  - title:
      de: "Kinder der Plage"
      en: "Child's Plague"
      fr: "Tenir tête au fléau"
      ja: "チャプリの移民"
      cn: "蚱蜢移民"
      ko: "큰메뚜기의 이민"
    id: "1180"
    icon: "060000/060721_hr1.png"
    desc: "Ala Mhigan legend tells of an ancient Gyr Abanian king whose pride angered the gods and brought upon his fertile land a plague of winged insects that devoured all grass and trees, leaving the desolate Peaks that remain to this day. The vilekin chapulis are believed by some to be the remnants of that plague."
    type: "Gegner Besiegen"
    fatelevel: "60"
    fatelevel_sync: "64"
  - title:
      de: "Und was sich reimt, ist Bhut"
      en: "Das Bhoot"
      fr: "Le don du repos éternel"
      ja: "エクソシスト"
      cn: "除灵"
      ko: "퇴마사"
    id: "1203"
    icon: "060000/060721_hr1.png"
    desc: "Their rage binding them to the corporeal realm, the spirits of young Ala Mhigans slain at the hands of Garlean invaders roam the Peaks seeking vengeance even now, more than twenty summers removed from the fall of their kingdom. Release the spirits from this world that they might finally find respite in the beyond."
    type: "Gegner Besiegen"
    fatelevel: "60"
    fatelevel_sync: "64"
  - title:
      de: "Die grauen Panteras"
      en: "Mouth for Water"
      fr: "Guerrière de la tribu des J"
      ja: "ジャ族の戦士"
      cn: "嘉氏的战士"
      ko: "자씨족 전사"
    id: "1205"
    icon: "060000/060724_hr1.png"
    desc: "Try as she might, J'najaq Sunflare is struggling to fend off the bloodthirsty panteras that threaten to maim and maul the J tribe maid who has come to the river to gather water. The warrioress sees you approach and sends a pleading glance."
    type: "Verteidigen"
    fatelevel: "68"
    fatelevel_sync: "72"
  - title:
      de: "Definitionssache"
      en: "Resist, Die, Repeat"
      fr: "Abnégation héroïque"
      ja: "チャプリの勇敢"
      cn: "勇敢的蚱蜢"
      ko: "용감한 큰메뚜기"
    id: "1201"
    icon: "060000/060724_hr1.png"
    desc: "A Resistance fighter is putting up his best resistance against a flock of fighting chapuli who are resisting all his attempts to break free from the fighting. Are you so cold as to resist the call to aid in his fight?"
    type: "Verteidigen"
    fatelevel: "60"
    fatelevel_sync: "64"
---
