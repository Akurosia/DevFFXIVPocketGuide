...
fates:
  - title:
      ...
      en: "The Spiderweb Chronicles"
      fr: "Défi : la colline a huit yeux"
      ja: "人喰い大蜘蛛「アンカブート」"
      cn: "食人大蜘蛛——安卡布特蛛"
      ko: "거대 식인 거미"
    id: "1130"
    icon: "060000/060722_hr1.png"
    desc: "The larger the spider, the larger the prey it must capture to sate its hunger...and Ankabut is one of the largest spiders to ever be reported in Eorzea. The muffled whimperings heard from the silken sacs on her webs suggest no one in Eorzea is safe."
    type: "Boss besiegen"
    fatelevel: "61"
    fatelevel_sync: "65"
  - title:
      de: "Die dicke Berda"
      en: "Flappy Berda"
      fr: "Défi : ça va barder pour Berda"
      ja: "白銀の人拐い「ベルダ」"
      cn: "白银的食人狮鹫——别尔达"
      ko: "백은색 유괴범"
    id: "1137"
    icon: "060000/060722_hr1.png"
    desc: "Once again, warriors of the M tribe hunt the Scourge of the Skies; the Feathered Fiend; White Death. The warriors hunt Berda, and welcome any who might seek to share in their glory."
    type: "Boss besiegen"
    fatelevel: "67"
    fatelevel_sync: "71"
  - title:
      de: "Die Saat des Bösen"
      en: "The Evil Seed"
      fr: "Défi : mauvaise graine"
      ja: "樹人の長老「キルニス」"
      cn: "树人长老——奇尔尼斯"
      ko: "나무인간 장로"
    id: "1129"
    icon: "060000/060722_hr1.png"
    desc: "Legend states that all diakka were born of seeds scattered by Kirnis in her wanderings across Gyr Abania. She continues her journey to this day, spawning more of the deadly seedkin while feeding herself upon the blood of unwary bystanders."
    type: "Boss besiegen"
    fatelevel: "61"
    fatelevel_sync: "65"
  - title:
      de: "Der Unnahbare"
      en: "Really Don't Keratyrannos"
      fr: "Défi : un tyran au ban"
      ja: "大角の脱走兵「ケラチラノス」"
      cn: "大角逃兵——有角暴君"
      ko: "뿔이 큰 탈주 병사"
    id: "1132"
    icon: "060000/060722_hr1.png"
    desc: "With their invasion, the Garleans brought with them myriad beasts of war and burden not native to Gyr Abania. Some of these, such as the keratyrannos, have escaped from their masters and now thrive in the highlands where they have no natural predators. Their numbers must be thinned before a disaster strikes."
    type: "Boss besiegen"
    fatelevel: "67"
    fatelevel_sync: "71"
  - title:
      de: "Klauen des Grauens"
      en: "Ananta and Her Sisters"
      fr: "Défi : sœurs vengeresses"
      ja: "鱗斬りの鉤爪「ジャターユ」"
      cn: "斩鳞钩爪——贾塔尤"
      ko: "비늘을 가르는 발톱"
    id: "1138"
    icon: "060000/060722_hr1.png"
    desc: "A party of Ananta battlemaids seek revenge for the wanton slaughter of several of their defenseless sisters at the hands of Jateryu─a bloodthirsty monster that rips open the bellies of its victims with its hooked claws. The battlemaids would not turn away those who might endeavor to aid their quest for ultion."
    type: "Boss besiegen"
    fatelevel: "67"
    fatelevel_sync: "71"
  - title:
      de: "Stolze Kriegerinnen"
      en: "M Bop"
      fr: "La chasse gardée des M"
      ja: "高い村の女"
      cn: "高村的女人"
      ko: "높은 마을의 여자"
    id: "1141"
    icon: "060000/060721_hr1.png"
    desc: "Archers of the M tribe will not suffer the likes of the Qalyana defiling their sacred hunting lands and are petitioning local adventurers to join them in driving off the sly serpentesses."
  ...
  - title:
      ...
      fr: "Pulsions déplacées"
      ja: "トンボ身重く横たわる"
      cn: "沉重的蜻蜓"
      ko: "잠자리는 무겁게 짓누른다"
    id: "1125"
    icon: "060000/060721_hr1.png"
    desc: "Swarms of skimmers─some of the vilest of all vilekin─have alighted in the Fringes to mate, and nothing works up an appetite like a frenzied fortnight of fornication. Unfortunately, skimmers have a taste for meat, preferably live, and will attack almost anything and everything that moves, be it livestock, pets, even something as large as a grown Roegadyn."
    type: "Gegner Besiegen"
    fatelevel: "61"
    fatelevel_sync: "65"
  - title:
      de: "Die mit den Bären tanzen"
      en: "Unbearable"
      fr: "Danse avec les ours"
      ja: "熊と踊れ"
      cn: "与熊共舞"
      ko: "곰과 함께 춤을"
    id: "1116"
    icon: "060000/060721_hr1.png"
    desc: "Drawn from their dens by the ripe odor of the Eorzean Alliance's latrines, mountain grizzly sightings have become increasingly common as of late, some of these chance encounters leading to serious maiming or even death. The Allied armies seek adventurers to frighten the beasts back into the hills."
    type: "Gegner Besiegen"
    fatelevel: "60"
    fatelevel_sync: "64"
  - title:
      de: "Ohne Moos mehr los"
      en: "Thank You for Not Mossling"
      fr: "Repousser les moussemousses"
      ja: "実はモス生まれ"
      cn: "苔藓制造机"
      ko: "실은 이끼 출신"
    id: "1126"
    icon: "060000/060721_hr1.png"
    desc: "While they appear harmless, mosslings are a threat to the fish that share the rivers in which they dwell. If left unchecked, a single colony of these swift-spawning, swift-growing seedkin can cover an entire lake in a matter of moons, blocking sunlight from reaching the riverbed, effectively killing the river's flora and the fauna that feed on it."
    type: "Gegner Besiegen"
    fatelevel: "60"
    fatelevel_sync: "64"
  - title:
    ...
    id: "1128"
    icon: "060000/060721_hr1.png"
    desc: "A company of Eorzean Alliance regulars has been ordered to slay a pack of deadly diakka believed to be the culprits in a disturbing string of missing draught chocobos. Never ones to underestimate their enemy, the company is requesting the assistance of nearby adventurers and is willing to split any spoils earned in the raid."
    type: "Gegner Besiegen"
    fatelevel: "61"
    fatelevel_sync: "65"
  - title:
      de: "Pflanzen mit großem Magen"
      en: "The Secret Life of Plants"
      fr: "Saprias, c'est fini"
      ja: "チルドレン・オブ・ザ・サプリア"
      cn: "寄生花的繁殖期"
      ko: "사프리아의 아이들"
    id: "1117"
    icon: "060000/060721_hr1.png"
    desc: "Gyr Abania has its share of unique highland flora, from prickly thistles, to verdant worts, to man-eating sapria. It suffices to say the latter is not one of which the local smallfolk think that highly."
    type: "Gegner Besiegen"
    fatelevel: "61"
    fatelevel_sync: "65"
  - title:
  ...
  - title:
    ...
    desc: "A storm herald carrying an important communication for his commanders is unable to cross the Velodyna, his way blocked by a school of goosefish. Part the waters and clear the poor man a path to freedom."
    type: "Verteidigen"
    fatelevel: "61"
    fatelevel_sync: "65"
---
